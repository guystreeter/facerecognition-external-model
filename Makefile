...
vendor/models/2/mmod_human_face_detector.dat: vendor/models/1/mmod_human_face_detector.dat
	mkdir -p $(dir $@)
	ln -s ${PWD}/$< $@

vendor/models/2/shape_predictor_68_face_landmarks.dat:
	$(call get_dat_file,$(@),https://github.com/davisking/dlib-models/raw/4af9b776281dd7d6e2e30d4a2d40458b1e254e40/shape_predictor_68_face_landmarks.dat.bz2)
...
vendor/models/3/shape_predictor_5_face_landmarks.dat: vendor/models/1/shape_predictor_5_face_landmarks.dat
	mkdir -p $(dir $@)
	ln -s ${PWD}/$< $@

vendor/models/3/dlib_face_recognition_resnet_model_v1.dat: vendor/models/1/dlib_face_recognition_resnet_model_v1.dat
	mkdir -p $(dir $@)
	ln -s ${PWD}/$< $@
...
serve: download-models
	...
	python facerecognition-external-model.py
